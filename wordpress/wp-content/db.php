...
$sqlite_plugin_implementation_folder_path = '/home/runner/workspace/wordpress/wp-content/plugins/sqlite-database-integration';
...
add_action(
	...
	function() {
		...
		$plugin_path = WP_PLUGIN_DIR . '/' . 'sqlite-database-integration/load.php';

		if ( file_exists( $plugin_path ) && is_plugin_inactive( 'sqlite-database-integration/load.php' ) ) {
