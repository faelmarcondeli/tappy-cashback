<?php
/**
 * E-mail: Lembrete de cashback expirando em 60 dias
 *
 * @var WC_Email $email
 ...
 * yourtheme/tappy-cashback-pro/emails/cashback-pendente-60d.php
 */
...
<p style="margin:0 0 16px;font-size:15px;line-height:1.5;">
    <?php esc_html_e('Você tem cashback disponível na nossa loja que vai expirar em breve. Que tal aproveitar?', 'tappy-cashback-pro'); ?>
</p>

<table cellspacing="0" cellpadding="0" border="0" width="100%" style="background:#fff8e1;border:1px solid #ffe082;border-radius:4px;margin:20px 0;">
    <tr>
        <td style="padding:16px 20px;">
            <p style="margin:0 0 6px;font-size:13px;color:#777;"><?php esc_html_e('Saldo disponível', 'tappy-cashback-pro'); ?></p>
            <p style="margin:0 0 12px;font-size:24px;color:#e07b00;font-weight:bold;"><?php echo wp_kses_post($balance); ?></p>
...
<p style="text-align:center;margin:0 0 12px;">
    <a href="<?php echo esc_url($shop_url); ?>" style="background:#e07b00;color:#ffffff;padding:12px 24px;text-decoration:none;border-radius:4px;display:inline-block;font-weight:bold;">
        <?php esc_html_e('Comprar agora', 'tappy-cashback-pro'); ?>
    </a>
</p>
